...
$("#goodsname").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#goodsname").after("<span id='goodsname_msg' style='color: red'>水果名称不能为空</span>");
			}
	});
...
$("#cateid").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#cateid").after("<span id='cateid_msg' style='color: red'>水果类型不能为空</span>");
			}
	});
...
$("#contents").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#contents").after("<span id='contents_msg' style='color: red'>水果详情不能为空</span>");
			}
	});
