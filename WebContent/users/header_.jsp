...
<div class="clearfix">
	<div class="block header">
		<div class="top clearfix">
			<a href="index.jsp" class="logo"><img src="themes/ecmoban_benlai/images/logo.gif"> </a>
			<div class="head_r">
...
<div class="menu_box clearfix">
	<div class="block main_menu">
		<div class="menu">
			...
			<a href="index/all.action" class="cur">全部水果</a> <a href="index/bbs.action" class="cur">留言交流</a>
		</div>
	</div>
</div>