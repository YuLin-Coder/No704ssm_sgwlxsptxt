							...
							<form action="index/register.action" method="post" name="myform">
								<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input type="radio" name="role" value="农户" title="农户"
											id="role" checked />农户&nbsp;&nbsp;&nbsp;<input type="radio" name="role" value="经销商" title="经销商" id="sex" />经销商</td>
									</tr>
									<tr>
